...
import { StyledBtnavbarItem } from './BtnavbarStyled';
    ...
    <>
      {Active == 'Home' ? (
        ...
        >
          ...
          <span style={styles.case1}>하우스</span>
        </StyledBtnavbarItem>
      ) : (
        <StyledBtnavbarItem
          onClick={() => {
        ...
        >
          ...
          <span style={styles.case2}>하우스</span>
        </StyledBtnavbarItem>
      )}
      {Active == 'Work' ? (
        <StyledBtnavbarItem
        ...
        >
          ...
          <span style={styles.case2}>가사 분담</span>
        </StyledBtnavbarItem>
      )}
      {Active == 'Rank' ? (
        <StyledBtnavbarItem
        ...
        >
          ...
          <span style={styles.case2}>완료지수</span>
        </StyledBtnavbarItem>
      )}
      {Active == 'Profile' ? (
        <StyledBtnavbarItem
        ...
        >
          ...
          <span style={styles.case2}>내 정보</span>
        </StyledBtnavbarItem>
      )}
    </>
  );
